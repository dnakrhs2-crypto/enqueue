...
if(WINSPARKLE_DIR)
    ...
    if(EXISTS "${_gocue_ws_header}" AND EXISTS "${_gocue_ws_lib}" AND EXISTS "${_gocue_ws_dll}")
        ...
        message(STATUS "Enqueue: WinSparkle found at ${_gocue_ws}")
    else()
        message(WARNING "Enqueue: WINSPARKLE_DIR='${_gocue_ws}' is missing include/winsparkle.h or x64/Release/WinSparkle.{lib,dll} -> building WITHOUT auto-update")
    endif()
else()
    message(STATUS "Enqueue: WINSPARKLE_DIR not set -> building WITHOUT auto-update")
endif()
