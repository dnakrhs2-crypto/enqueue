...
if(ASIO_SDK_DIR)
    ...
    if(EXISTS "${_gocue_asio_dir}/common/iasiodrv.h")
        ...
        message(STATUS "GoCue: ASIO SDK found at ${_gocue_asio_dir} -> JUCE_ASIO=1")
    else()
        message(WARNING "GoCue: ASIO_SDK_DIR='${_gocue_asio_dir}' does not contain common/iasiodrv.h -> building WITHOUT ASIO (WASAPI only)")
    endif()
else()
    message(WARNING "GoCue: ASIO_SDK_DIR is not set -> building WITHOUT ASIO (WASAPI only). See README.md.")
endif()
