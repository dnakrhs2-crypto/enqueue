...
{
enum class RecorderCommand { recordStart, recordStop, playStop, split, marker, saveProject, count };
struct RecorderShortcuts
{
    ...
    std::array<juce::String, count> keys {"F9", "spacebar", "spacebar", "S", "M", "ctrl + S"};
