...
public:
    ...
    static ClipEditResult trimIn(const RecorderProject&, const std::vector<Id>& clipIds, Sample timelineSample);
    static ClipEditResult trimOut(const RecorderProject&, const std::vector<Id>& clipIds, Sample timelineSample);
    ...
    static ClipEditResult move(const RecorderProject&, const std::vector<Id>& clipIds, Sample deltaSamples);
